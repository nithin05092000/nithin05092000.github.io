    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <ul>
                    <li><a href="<?php echo site_url('home/my_courses'); ?>"><?php echo site_phrase('courses'); ?></a></li>
                    <li><a href="<?php echo site_url('home/my_messages'); ?>"><?php echo site_phrase('messages'); ?></a></li>
                    <li><a href="<?php echo site_url('home/my_wishlist'); ?>"><?php echo site_phrase('wishlists'); ?></a></li>
                    <li class="active"><a href=""><?php echo site_phrase('profile'); ?></a></li>
                </ul>
            </div>
        </div>
    </div>
