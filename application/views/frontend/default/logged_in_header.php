            ...
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <script src="https://www.gstatic.com/dialogflow-console/fast/messenger/bootstrap.js?v=1"></script>
                        <df-messenger
                        intent="WELCOME"
                        chat-icon="http://localhost/AI/uploads/system/logo-dark.png"
                        chat-title="Chat Bot"
                        agent-id="553ac8ca-cc77-44ae-9752-fa14cb938352"
                        language-code="en"
                        ></df-messenger>
                    ...
                    <div class="instructor-box menu-icon-box">
                        <div class="icon">
                            <a href="http://localhost:8501" style="border: 1px solid transparent; margin: 10px 10px; font-size: 14px; width: 100%; border-radius: 0; min-width: 100px;"><?php echo site_phrase('recommender'); ?></a>
                        </div>
                    </div>
